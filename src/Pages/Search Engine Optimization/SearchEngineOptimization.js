...
import ImageContent1 from './web traffic.jpg';
...
const SearchEngineOptimization = () => {
  return (
    ...
    Paragraph='Premium Search Engine Optimization Servicesto Get You in Google"s Good Books'
    CTA='Call Now'
    TitleColor='#f40000'
    CTAColor='#f40000'
  ...
  <LeftContent 
    Title='Professional SEO Leads to the Increment of Your Brand’s Growth'
