...
const LeftContent = ({Title, Paragraph, CTA, ImgURL, TitleColor, CTAColor, CTABorderColor}) => {
  return (
    <div>
        ...
        <section>
            <div className="container px-5">
                <div className="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    <div className="col-12-text-center col-lg-5 ms-3 mb-5">
                    ...
                    <div className="col-sm-8 col-md-6">
                        <div className="px-5 px-sm-0"><img className="img-fluid" src={ImgURL} alt={Title} /></div>
                    </div>
                </div>
            </div>
        </section>
