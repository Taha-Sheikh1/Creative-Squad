            ...
            <div className="container px-5">
                <div className="row gy-4 gx-2 align-items-center justify-content-center justify-content-lg-between">   
                    <div className="col-sm-8 col-md-6 ms-5">
                        <div className="px-0"><img className="img-fluid" src={require('./Contact-Banner.png')} alt='Contact Us Banner' /></div>
                    </div>
                    <div className="col-12-text-center col-lg-5">
                    <h2 className='ContactHeading mb-0'>Start Your Journey To<br /> <span>Digital Success</span></h2>
