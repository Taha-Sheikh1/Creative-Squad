...
<div className='container Navbar'>
  ...
  <li> 
           <li className='nav-item'><NavLink to={'/digital-marketing-services-in-toronto'} className={navData => navData.isActive ? 'nav-link' : 'nav-link'}><span>Services <FontAwesomeIcon  onClick={
              DropDownHandler
            } icon={faChevronDown} /></span></NavLink></li>
