...
const Results = () => {
  return (
    ...
    <section className='py-5 pt-4 pb-2 mb-0'>
    <h1 className='text-center'>How We Provide <span>Results</span></h1>
        <div className='container px-2 my-5 text-center'>
            <div className='row g-2 pt-2'>
              ...
              <p className='Result_Paragraph'>Breaking away from generalized patterns, we bring you unique solutions tailor-made especially for your brand.</p>
              </div>
              </div>
