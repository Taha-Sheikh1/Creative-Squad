  ...
  return (
    ...
    <section className='Services mt-0'>
      ...
      <div className='container'>
         ...
         <h2 className='mt-0 mb-3 text-center Services'>360 <span className='DigitalServices'>Digital Services</span></h2>
        ...
        <div className='row text-center mt-2'>
            ...
            <div className='col-lg-4'>
               ...
               <h2 className='ServicesTitle'>Branding</h2>
               <p className='ServicesPara'>We'll help your brand appeal to the masses by using aesthetic colors.</p>
            ...
            <div>
               ...
               <p className='ServicesPara'>We use WordPress, Shopify, and Magento to build smooth and functional websites.</p>
