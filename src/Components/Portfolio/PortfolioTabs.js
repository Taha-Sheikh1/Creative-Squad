...
<ul className="nav nav-tabs d-flex justify-content-center" id="myTab" role="tablist">
  ...
  <li className="nav-item">
    <button className={TogglePics === 1 ? 'nav-link active' : 'nav-link'} onClick={(evt) => {
     evt.preventDefault();
     TogglePictures(1);
     }} id="home-tab" data-bs-toggle="tab" data-bs-target="#web-design" type="button" role="tab" aria-controls="web-design">Web Design</button>
  </li>
  ...
  <li className="nav-item">
    <button className={TogglePics === 2 ? 'nav-link active' : 'nav-link'} id="profile-tab" onClick={(evt) => {
       evt.preventDefault();
       TogglePictures(2);
    }} data-bs-toggle="tab" data-bs-target="#branding" type="button" role="tab" aria-controls="branding">Branding</button>
  </li>
  ...
  <li className="nav-item">
    <button className={TogglePics === 3 ? 'nav-link active' : 'nav-link'} id="contact-tab" onClick={(evt) => {
      evt.preventDefault();
      TogglePictures(3);
    }} data-bs-toggle="tab" data-bs-target="#social-media-marketing" type="button" role="tab" aria-controls="social-media-marketing">Social Media Marketing</button>
  </li>
  ...
  <li className="nav-item">
    <button className={TogglePics === 4 ? 'nav-link active' : 'nav-link'} id="contact-tab" onClick={(evt) => {
      evt.preventDefault();
      TogglePictures(4);
    }} data-bs-toggle="tab" data-bs-target="#web-applications" type="button" role="tab" aria-controls="web-applications">Web Applications</button>
  </li>
  ...
  <li className="nav-item">
    <button className={TogglePics === 5 ? 'nav-link active' : 'nav-link'} id="contact-tab" onClick={(evt) => {
      evt.preventDefault();
      TogglePictures(5);
    }} data-bs-toggle="tab" data-bs-target="#eCommerce" type="button" role="tab" aria-controls="eCommerce">eCommerce</button>
  </li>
