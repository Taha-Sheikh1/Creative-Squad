...
<ul className="nav nav-tabs d-flex justify-content-center" id="myTab" role="tablist">
  ...
  <li className="nav-item">
    <button className={TogglePics === 5 ? 'nav-link active' : 'nav-link'} id="contact-tab" onClick={(evt) => {
      evt.preventDefault();
      TogglePictures(5);
    }} data-bs-toggle="tab" data-bs-target="#eCommerce" type="button" role="tab" aria-controls="eCommerce">SMM</button>
  </li>
  ...
  <li className="nav-item">
    <button className={TogglePics === 6 ? 'nav-link active' : 'nav-link'} id="contact-tab" onClick={(evt) => {
      evt.preventDefault();
      TogglePictures(6);
    }} data-bs-toggle="tab" data-bs-target="#mobile-applications" type="button" role="tab" aria-controls="mobile-applications">Mobile Development</button>
  </li>
